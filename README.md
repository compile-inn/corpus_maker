# Corpus Maker
This short script takes a text file and returns a list of its words stored in JSON format (txt file -> list JSON). The list is built by excluding spaces and punctuations, and by only keeping workds of minimal length of your choosing.
